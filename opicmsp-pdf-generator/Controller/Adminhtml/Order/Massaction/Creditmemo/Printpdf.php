 ...
 * Class Printpdf
 *
 * @package Eadesigndev\Opicmsppdfgenerator\Controller\Adminhtml\Order\Massaction\Creditmemo
...
class Printpdf extends AbstractMassAction
{
     ...
     * @param Filter $filter
     * @param CreditMemoCollectionFactory $collectionFactory
    ...
    public function __construct(
        Context $context,
        Filter $filter,
        CreditMemoCollectionFactory $collectionFactory,
